...
export const ITEMS: Item[] = [
  { id: "rainbow-jelly", name: "Rainbow Jelly", image: "https://cdn.builder.io/api/v1/image/assets%2F63c936af87bb4092b7300f333f376cfe%2F169a88c0acba49598cbd59a09cecf89b?format=webp&width=800", category: "pet", stock: 3, priceUSD: 24, tags: ["best"] },
  ...
  { id: "rainbow-orb-guardian", name: "Rainbow Orb Guardian", image: "https://cdn.builder.io/api/v1/image/assets%2F63c936af87bb4092b7300f333f376cfe%2Fc484f773196d4d0ea2201b746fd2a424?format=webp&width=800", category: "plant", stock: 3, priceUSD: 22, tags: ["mega"] },
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="flex items-center gap-2 mr-4 pr-4 border-r border-white/6">
                    <Button className={`filter-custom isolate-filter ${filter === "all" ? "active" : ""} bg-slate-900/80 text-white border border-white/10 px-3 py-2 rounded-md shadow-sm hover:bg-slate-900/95`} size="sm" onClick={() => setFilter("all")}><span className="laser" aria-hidden />All</Button>

                    <Button className={`filter-custom isolate-filter ${filter === "best" ? "active" : ""} bg-slate-900/80 text-white border border-white/10 px-3 py-2 rounded-md shadow-sm hover:bg-slate-900/95`} size="sm" onClick={() => setFilter("best")}><span className="laser" aria-hidden /><span className="inline-flex items-center gap-2"><img src="https://cdn.builder.io/api/v1/image/assets%2Fd298c54982d64a0783c9a8a3d1e480c1%2Fa52a865175de4ee0b13ba303cef212f7?format=webp&width=800" alt="fire" className="h-7 w-7 object-contain" aria-hidden /><span className="bg-clip-text text-transparent bg-gradient-to-r from-rose-500 via-orange-400 to-yellow-300 font-extrabold tracking-wide">BestSellers</span>
                    </span>
                    <div className="best-slider" />
                  </Button>
                  </div>

                  <Button className={`filter-custom ${filter === "mutated" ? "active" : ""} bg-slate-900/80 text-white border border-white/10 px-3 py-2 rounded-md shadow-sm hover:bg-slate-900/95`} size="sm" onClick={() => setFilter("mutated")}><span className="laser" aria-hidden />Mutated Pets</Button>
                </div>
